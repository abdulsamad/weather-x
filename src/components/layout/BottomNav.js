...
function BottomNav() {
  ...
  return (
    <nav className='relative flex bg-white z-10 w-full shadow' style={{ height: 60 }}>
      <NavLink
        exact
        to={`/${place}`}
      ...
      <NavLink
        ...
        <span className='sr-only'>Next 48 Hours</span>
      </NavLink>
      <NavLink
        exact
        to={`/${place}/Next7Days`}
        ...
        <span className='sr-only'>Next 7 Days</span>
      </NavLink>
      <NavLink
        exact
        to={`/${place}/Stats`}
